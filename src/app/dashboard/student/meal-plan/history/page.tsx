...
// Same phrasing convention as heightLabel/weightLabel/growthHeadline in
// ../page.tsx — kept local since those aren't exported from that page module.
...
export default function MealPlanHistoryPage() {
  ...
  // fetchMealPlanHistory returns newest-first; charts read chronologically.
  const chronological = plans ? [...plans].reverse() : [];
