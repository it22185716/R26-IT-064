...
const NAV_SECTIONS: { heading: string; items: NavItem[] }[] = [
  {
    heading: 'Dashboard',
    items: [
      { href: '/dashboard/teacher', label: 'Adaptive Learning', icon: ICONS.overview, exact: true },
      { href: '/dashboard/teacher/meal-plan', label: 'Meal & Nutrition', icon: ICONS.mealNutrition },
      { href: '/dashboard/teacher/reading', label: 'Reading Progress', icon: ICONS.reading },
    ],
  },
];
...
export default function TeacherShell({ userName, title, children }: Props) {
  ...
  const sidebar = (
    <div className="flex h-full flex-col border-r border-stone-200 bg-white">
      <Link href="/dashboard/teacher" className="flex items-center gap-3 border-b border-stone-200 px-5 py-5">
        <Image
          src="/logo.png"
