...
const NAV_SECTIONS: { heading: string; items: NavItem[] }[] = [
  {
    heading: 'Dashboard',
    items: [{ href: '/dashboard/admin', label: 'Overview', icon: ICONS.overview, exact: true }],
  },
  {
    heading: 'Management',
    items: [
      { href: '/dashboard/admin/users', label: 'Users', icon: ICONS.students },
      { href: '/dashboard/admin/audit-log', label: 'Audit Log', icon: ICONS.auditLog },
    ],
  },
];
...
export default function AdminShell({ userName, title, children }: Props) {
  ...
  const sidebar = (
    <div className="flex h-full flex-col border-r border-stone-200 bg-white">
      <Link href="/dashboard/admin" className="flex items-center gap-3 border-b border-stone-200 px-5 py-5">
        <Image
          src="/logo.png"
